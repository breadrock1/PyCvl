...
def canny(frame: ndarray, low: float, high: float, size: float = 3, is_l2: bool = False) -> ndarray:
    """
...
def canny_sigma(frame: ndarray, size: int = 3, sigma: float = 0.05, is_l2: bool = False) -> ndarray:
    """
...
def vibration(frame: ndarray, color_bounds: PyColorBounds, neighbours: int = 8, window_size: int = 2) -> ndarray:
    """
